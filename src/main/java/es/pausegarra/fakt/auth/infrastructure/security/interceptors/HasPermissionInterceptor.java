package es.pausegarra.fakt.auth.infrastructure.security.interceptors;

import es.pausegarra.fakt.auth.domain.repositories.KeycloakRepository;
import es.pausegarra.fakt.auth.infrastructure.config.KeycloakConfig;
import es.pausegarra.fakt.auth.infrastructure.security.annotations.HasPermission;
