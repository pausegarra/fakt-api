package es.pausegarra.fakt.auth.infrastructure.security.augmentors;

import es.pausegarra.fakt.auth.infrastructure.security.suppliers.KeycloakIdentitySupplier;
